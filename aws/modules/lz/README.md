...
This is not a published Landing Zone product. Nested `regional_vpc` and `http_edge` are implementation details. The module does not create an ECS cluster and does not write the handoff secret (the example does).
