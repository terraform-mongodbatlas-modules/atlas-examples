# variables_generated.tf -- generated by: just extract-regions gcp (from gcp repository)
variable "atlas_to_gcp_region" {
  ...
  description = <<-EOT
    ...
    The example accepts either format in all region inputs and normalizes internally.
